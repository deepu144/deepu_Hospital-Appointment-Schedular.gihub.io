					...
					<div class="inner">
						<div class="row">
							<div class="col-lg-3 col-md-3 col-12">
								<div class="logo">
									<a href="/doctor/home"><img src="/img/KceLogo.png" alt="#" height="50px" width="50px"></a>
									<h4>Karpagam</h4>
								</div>
								...
								<div class="main-menu">
									<nav class="navigation">
										<ul class="nav menu">
											...
											<li class="active"><a href="/doctor/home">Services <i class="icofont-rounded-down"></i> </a>
	                        ...
	                        <div class="doctor_info">
	                            ...
	                            <div class="doctor_details" style="margin-left: 25px;">
	                                <div class="doctor_name"  style="margin-top: 15px;">
	                                   <div id="doctor_name_id" class="dept_name_btn"><%= doc.getName() %></div> 
	                                </div>
